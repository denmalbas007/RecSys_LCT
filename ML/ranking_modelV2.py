...
def recommendation(whole_data: pd.DataFrame, period: list) -> OrderedDict:
    ...
    x = [[float(inccorect_month[0])], [float(inccorect_month[1])], [float(inccorect_month[2])],
         [float(inccorect_month[3])]]
...
def main():
    ...
    ranking_dict = recommendation(whole_data, ['09/2021', '10/2021', '11/2021', '12/2021'])
    top_10 = 0
