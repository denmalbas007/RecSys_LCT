...
services.AddHttpClient(nameof(MlClient), client => client.BaseAddress = PlatformEnvironment.IsRunningInContainer ? new Uri("http://ml-api/") : new Uri("http://localhost:8000/"));
